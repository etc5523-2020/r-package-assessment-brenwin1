...
These plots constructed using `ggplot2` allowing for additions if desired. For example, instead of overlaying each countr(ies) plots over one another we could `facet` to see the daily cases trend of both countries.
```{r}
